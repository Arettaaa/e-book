...
<section class="featured" id="featured">
    ...
    <h1 class="heading"> <span>Buku Biografi</span> </h1>
    ...
    <div class="swiper featured-slider">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide box">
                ...
                <div class="image">
                    <img src="image/gusdur.png" alt="">
                </div>
                <div class="content">
                    <h3>Gus Dur</h3>
                    <div class="price">Greg Bartton</div>
            ...
            <div class="swiper-slide box">
                ...
                <div class="image">
                    <img src="image/bjhabibie.jpg" alt="">
                </div>
                <div class="content">
                    <h3>B.j. Habibie</h3>
                    <div class="price">weda s. atma</div>
                    <a href="#" class="btn">read more</a>
                </div>
            </div>
            ...
            <div class="swiper-slide box">
                ...
                <div class="image">
                    <img src="image/elonmusk.jpg" alt="">
                </div>
                <div class="content">
                    <h3>Elon Musk</h3>
                    <div class="price">ashlee vance</div>
                    <a href="#" class="btn">read more</a>
                </div>
            </div>
